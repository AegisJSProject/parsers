...
### Changed
- Allow `comments` and `dataAttribtues` in HTML & SVG for reactive/signal libraries

## [v0.1.5] - 2026-01-09

### Changed
- Use `<template>` in `html` for better performance & security
- Switch to using `@shgysk8zer0/http-server` for testing for better compatibility
